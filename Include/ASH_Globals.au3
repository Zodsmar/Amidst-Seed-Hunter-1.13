...
Global $timeToWait, $timeToWaitGUI
...
Func UpdateGlobals()
	...
	Else
		...
		IniWriteSection($settingsINIFile, "BiomeList", _
			...
			"Cold Deep Ocean=0x202038"				& @LF & _
			"Cold Ocean=0x202070"					& @LF & _
			...
			"Frozen Deep Ocean=0x404090" 			& @LF & _
			"Frozen Ocean=0x7070D6" 				& @LF & _
			...
			"Lukewarm Deep Ocean=0x000040"			& @LF & _
			"Lukewarm Ocean=0x000090"				& @LF & _
			...
			"Taiga M=0x338E81"						& @LF & _
			"Warm Deep Ocean=0x000050"				& @LF & _
			"Warm Ocean=0x0000AC"					)
